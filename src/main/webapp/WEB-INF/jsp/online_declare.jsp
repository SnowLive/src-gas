...
<div class="section" style="border-bottom: 1px solid #e9e9e9;">
  <div class="container">
    ...
    <div class="section--header">
      <h2 class="section--title">在线申报</h2>
      <p class="section--description">简化办事流程，关注申报动态。</p>
    </div>
      ...
      <div class="am-g">
        ...
        <div class="am-u-md-6">
          <div class="service_item">
            ...
            <footer class="service_item--footer"><a href="/declares/list" class="link -blue_light">Learn More>></a>
            </footer>
          </div>
        </div>
        <!--状态查询-->
        <div class="am-u-md-6">
          <div class="service_item">
            ...
            <footer class="service_item--footer"><a href="/declares/state" class="link -blue_light">Learn More>></a>
            </footer>
          </div>
        </div>
